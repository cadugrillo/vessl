...
func main() {
	...
	r.POST("/containers/:Id/inspect", helpers.ValidateApiKey(), handlers.InspectContainerHandler)
	...
	r.POST("/images/:Id/inspect", helpers.ValidateApiKey(), handlers.InspectImageHandler)
	...
	r.POST("/volumes/:Id/inspect", helpers.ValidateApiKey(), handlers.InspectVolumeHandler)
	...
	r.POST("/networks/:Id/inspect", helpers.ValidateApiKey(), handlers.InspectNetworkHandler)
